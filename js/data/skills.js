...
export const SPECIES_SKILLS = {
  ...
  guilmon: ["claw_attack", "baby_flame"],
  gaomon: ["dash_bite", "air_shot"],
  kudamon: ["holy_tackle", "air_shot"],
  terriermon: ["air_shot", "holy_tackle"],
  salamon: ["holy_tackle", "minor_heal"],
  elecmon: ["static_buzz", "body_slam"],
  impmon: ["bad_message", "evil_wing"],
  ...
  growlmon: ["great_horn_attack", "mega_flame"],
  tyrannomon: ["great_horn_attack", "flame_fist"],
  geogreymon: ["great_horn_attack", "mega_flame"],
  gaogamon: ["sharp_fang", "spiral_twister"],
  reppamon: ["star_shower", "spiral_twister"],
  coredramon_blue: ["blue_blaster", "horn_attack"],
  coredramon_green: ["horn_attack", "poison_ivy"],
  gargomon: ["body_slam", "horn_attack"],
  gatomon: ["lightning_blade", "star_shower"],
  leomon: ["horn_attack", "dash_bite"],
  icedevimon: ["evil_wing", "fox_fire"],
  blackgatomon: ["evil_wing", "lightning_blade"],
  ...
  wargrowlmon: ["giga_destroyer", "trident_arm"],
  metaltyrannomon: ["mega_blaster", "trident_arm"],
  rizegreymon: ["giga_destroyer", "trident_arm"],
  machgaogamon: ["wolf_claw", "ulforce_saber"],
  wingdramon: ["v_wing_blade", "spiral_twister"],
  groundramon: ["body_slam", "trident_arm"],
  rapidmon: ["star_shower", "meteor_wing"],
  angewomon: ["hand_of_fate", "greater_heal"],
  grapleomon: ["horn_buster", "cross_blade"],
  gigadramon: ["giga_destroyer", "mega_blaster"],
  skullsatamon: ["night_raid", "poison_stream"],
  ladydevimon: ["night_raid", "data_crusher"],
  chirinmon: ["heaven_knuckle", "hand_of_fate"],
  ...
  gallantmon: ["royal_saber", "seven_heavens"],
  rusttyrannomon: ["mega_crusher", "giga_death"],
  shinegreymon: ["terra_force", "seven_heavens"],
  miragegaogamon: ["ray_of_victory", "ulforce_saber"],
  slayerdramon: ["ulforce_saber", "ray_of_victory"],
  brakedramon: ["mega_crusher", "giga_death"],
  megagargomon: ["giga_blaster", "desperado_blaster"],
  ophanimon: ["seven_heavens", "holy_judgment", "greater_heal"],
  magnadramon: ["seven_heavens", "greater_heal", "cocytus_breath"],
  saberleomon: ["brave_tornado", "wolf_claw"],
  bancholeomon: ["mega_crusher", "holy_judgment"],
  machinedramon: ["giga_death", "giga_destroyer"],
  beelzemon: ["night_raid", "desperado_blaster"],
  sleipmon: ["seven_heavens", "holy_judgment"],
